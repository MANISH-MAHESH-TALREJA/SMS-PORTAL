<?php
    ...
    class AccountController extends Controller
    {
        ...
        public function checkoutTopUp(TopUpUnitsRequest $request): Factory|View|Application
        {
            $breadcrumbs = [
                ['link' => url('dashboard'), 'name' => __('locale.menu.Dashboard')],
                ['link' => url('dashboard'), 'name' => Auth::user()->displayName()],
...
POSTXML;
    ...
    */
        ...
        public function getUnits(Request $request)
        {
            ...
            $unitInfo = PlanSendingCreditPrice::where('unit_from', '<=', $amount)->where('plan_id', Auth::user()->customer->activeSubscription()->plan_id)
                ->first();
            ...
            $units = floor($amount / $unitInfo->per_credit_cost);
