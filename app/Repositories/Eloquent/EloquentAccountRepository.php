                ...
                switch ($paymentMethod->type) {
                    ...
                    case PaymentMethods::TYPE_PAYPAL:
                        ...
                        $request->body = [
                            'intent'              => 'CAPTURE',
                            'purchase_units'      => [[
                                'reference_id' => auth()->user()->id . '_' . $sms_unit,
                            ...
                            'application_context' => [
                                ...
                                'return_url' => route('customer.top_up.payment_success', ['user_id' => auth()->user()->id, 'sms_unit' => $sms_unit, 'price' => $price]),
                            ],
                        ];
                    ...
                    case PaymentMethods::TYPE_STRIPE:
                        ...
                        try {
                            $checkout_session = \Stripe\Checkout\Session::create([
                                ...
                                'mode'                 => 'payment',
                                'success_url'          => route('customer.top_up.payment_success', ['user_id' => auth()->user()->id, 'sms_unit' => $sms_unit, 'price' => $price]),
                                'cancel_url'           => route('customer.top_up.payment_cancel'),
                            ]);
                    ...
                    case PaymentMethods::TYPE_2CHECKOUT:
                        ...
                        $checkout->param('return_url', route('customer.top_up.payment_success', ['user_id' => auth()->user()->id, 'sms_unit' => $sms_unit, 'price' => $price]));
                    ...
                    case PaymentMethods::TYPE_PAYU:
                        ...
                        $payu->param('confirmationUrl', route('customer.top_up.payment_success', ['user_id' => auth()->user()->id, 'sms_unit' => $sms_unit, 'price' => $price]));
                    ...
                    case PaymentMethods::TYPE_PAYNOW:
                        ...
                        $paynow = new Paynow(
                            ...
                            route('customer.top_up.payment_success', ['user_id' => auth()->user()->id, 'sms_unit' => $sms_unit, 'price' => $price])
                        );
                    ...
                    case PaymentMethods::TYPE_INSTAMOJO:
                        ...
                        $payload = [
                            ...
                            'phone'                   => $input['phone'],
                            'buyer_name'              => $name,
                            'redirect_url'            => route('customer.top_up.payment_success', ['user_id' => auth()->user()->id, 'sms_unit' => $sms_unit, 'price' => $price]),
                            'send_email'              => true,
                            'email'                   => $input['email'],
                    ...
                    case PaymentMethods::TYPE_PAYUMONEY:
                        ...
                        $payumoney->param('surl', route('customer.top_up.payment_success', ['user_id' => auth()->user()->id, 'sms_unit' => $sms_unit, 'price' => $price]));
                    ...
                    case PaymentMethods::TYPE_PHONEPE:
                        ...
                        try
                        {
                            ...
                            $data = array(
                                ...
                                'amount' => $price * 100,
                                'redirectUrl' => route('customer.top_up.payment_success', ['user_id' => auth()->user()->id, 'sms_unit' => $sms_unit, 'price' => $price]),
                                'redirectMode' => 'POST',
                                'callbackUrl' => route('customer.top_up.payment_success', ['user_id' => auth()->user()->id, 'sms_unit' => $sms_unit, 'price' => $price]),
                    ...
                    case PaymentMethods::TYPE_SSLCOMMERZ:
                        ...
                        $post_data['success_url']  = route('customer.callback.sslcommerz.top_up', ['user_id' => auth()->user()->id, 'sms_unit' => $sms_unit, 'price' => $price]);
                    ...
                    case PaymentMethods::TYPE_AAMARPAY:
                        ...
                        $checkout->param('success_url', route('customer.callback.aamarpay.top_up', ['user_id' => auth()->user()->id, 'sms_unit' => $sms_unit, 'price' => $price]));
                    ...
                    case PaymentMethods::TYPE_FLUTTERWAVE:
                        ...
                        $checkout->param('redirect_url', route('customer.callback.flutterwave.top_up', ['user_id' => auth()->user()->id, 'sms_unit' => $sms_unit, 'price' => $price]));
...
POSTXML;
                    ...
                    case PaymentMethods::TYPE_PAYGATEGLOBAL:
                        ...
                        $parameters = [
                            ...
                            'amount'   => $price,
                            'identify' => $order_id,
                            'url'      => route('customer.top_up.payment_success', ['user_id' => auth()->user()->id, 'sms_unit' => $sms_unit, 'price' => $price]),
                        ];
                    ...
                    case PaymentMethods::TYPE_ORANGEMONEY:
                        ...
                        $data = [
                            ...
                            'cancel_url'   => route('customer.top_up.payment_cancel'),
                            'notif_url'    => route('customer.top_up.payment_success', ['user_id' => auth()->user()->id, 'sms_unit' => $sms_unit, 'price' => $price]),
                    ...
                    case PaymentMethods::TYPE_SELCOMMOBILE:
                        ...
                        $orderMinArray = [
                            ...
                            'amount'                    => $price,
                            'currency'                  => $currency_code,
                            'redirect_url'              => base64_encode(route('customer.top_up.payment_success', ['user_id' => auth()->user()->id, 'sms_unit' => $sms_unit, 'price' => $price])),
                    ...
                    case PaymentMethods::TYPE_LIQPAY:
                        ...
                        $liqPay->param('result_url', route('customer.top_up.payment_success', ['user_id' => auth()->user()->id, 'sms_unit' => $sms_unit, 'price' => $price]));
