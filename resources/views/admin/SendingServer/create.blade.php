                            ...
                            <div class="card-body">
                                ...
                                @switch($server['settings'])
                                    ...
                                    @case(SendingServer::TYPE_MESSAGEBIRD)
                                        <p> {!! __('locale.description.messagebird', ['brandname' => config('app.name'), 'inbound_url' => route('inbound.bird')]) !!}</p>
                                        @break
                                    ...
                                    @case(SendingServer::TYPE_SMSTO)
                                        <p> To Receive Delivery reports please login with your SMSTO portal and navigate
                                            ...
                                            <code> {{ route('dlr.smsto') }}</code> on your <code>Default Outbound
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_INFOBIP || $server['settings'] == SendingServer::TYPE_TELNYX || $server['settings'] == SendingServer::TYPE_BULKSMSPROVIDERNG || $server['settings'] == SendingServer::TYPE_AIRTELINDIA || $server['settings'] == SendingServer::TYPE_ALDEAMO)
                                            <div class="col-12">
                                                <div class="mb-1">
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_MSG91 || $server['settings'] == SendingServer::TYPE_VOICEANDTEXT || $server['settings'] == SendingServer::TYPE_SMSURWAY)
                                            <div class="col-12">
                                                <div class="mb-1">
                                        ...
                                        @if($server['settings'] == 'Twilio' || $server['settings'] == 'TwilioCopilot' || $server['settings'] == 'Skyetel' || $server['settings'] == SendingServer::TYPE_TEXTGRID )
                                            <div class="col-12">
                                                <div class="mb-1">
                                        ...
                                        @if($server['settings'] == 'AmazonSNS' || $server['settings'] == 'FlowRoute' || $server['settings'] == SendingServer::TYPE_ALIBABACLOUDSMS || $server['settings'] == SendingServer::TYPE_MESSAGEBIRD)
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_TOPYING)
                                        ...
                                        @if($server['settings'] == 'GatewaySa' || $server['settings'] == 'SendPulse' || $server['settings'] == SendingServer::TYPE_DIGINTRA || $server['settings'] == SendingServer::TYPE_TONKRA)
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_INFOBIP || $server['settings'] == SendingServer::TYPE_NIMBUZ || $server['settings'] == SendingServer::TYPE_OZONESMS || $server['settings'] == SendingServer::TYPE_AMAZONSNS || $server['settings'] == SendingServer::TYPE_FAST2SMS|| $server['settings'] == SendingServer::TYPE_SMSGATEWAYHUB)
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="d-flex justify-content-start flex-wrap col-12">
                                            ...
                                            @if($server['settings'] == 'Twilio' || $server['settings'] == 'TextLocal' || $server['settings'] == 'Plivo' || $server['settings'] == 'PlivoPowerpack' || $server['settings'] == 'SMSGlobal' || $server['settings'] == SendingServer::TYPE_MESSAGEBIRD || $server['settings'] == 'WhatsAppChatApi' || $server['settings'] == 'SignalWire' || $server['settings'] == 'Telnyx' || $server['settings'] == 'TelnyxNumberPool' || $server['settings'] == 'Bandwidth' || $server['settings'] == 'Skyetel' || $server['settings'] == 'TxTria' || $server['settings'] == 'Whatsender' || $server['settings'] == SendingServer::TYPE_TELEAPI || $server['settings'] == SendingServer::TYPE_MMSCONSOLE || $server['settings'] == SendingServer::TYPE_BMSGLOBAL || $server['settings'] == SendingServer::TYPE_MESSAGGIO || $server['settings'] == SendingServer::TYPE_WAVIX || $server['settings'] == SendingServer::TYPE_TEXTGRID)
                                            ...
                                            @if($server['settings'] == SendingServer::TYPE_MSG91 || $server['settings'] == SendingServer::TYPE_SMARTSMSSOLUTIONS || $server['settings'] == SendingServer::TYPE_VOICEANDTEXT  || $server['settings'] == SendingServer::TYPE_FAST2SMS || $server['settings'] == SendingServer::TYPE_SMSURWAY || $server['type'] == 'otp')
                                                <div class="d-flex flex-column">
