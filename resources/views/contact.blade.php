            ...
            <div class="col-md-6 col-sm-10 col-lg-4">
                <div class="contact-item">
                    ...
                    <div class="contact-content">
                        ...
                        <ul>
                            <li>Mira Bhayander Road</li>
                            <li>Mumbai, Maharashtra, Indi</li>
                            <li>THANE - 401107</li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-sm-10 col-lg-4">
                <div class="contact-item">
                    ...
                    <div class="contact-content">
                        ...
                        <ul>
                            <li><a href="{{ url("tel:+919833137409") }}">+91 9833137409</a></li>
                            <li><a href="{{ url("tel:+918104621778") }}">+91 8104621778</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-sm-10 col-lg-4">
                <div class="contact-item">
                    ...
                    <div class="contact-content">
                        ...
                        <ul>
                            <li>
                                <a href="{{ url("mailto:support@makememessage.com") }}">support@makememessage.com</a>
                            </li>
                        </ul>
                    </div>
                </div>
