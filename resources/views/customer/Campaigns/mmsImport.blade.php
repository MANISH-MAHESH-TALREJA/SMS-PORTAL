                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form class="form form-vertical" action="{{ route('customer.mms.import') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-1">
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <select class="select2 form-select" name="sending_server" id="sending_server">
                                                    @foreach($sendingServers as $server)
                                                        @if(isset($server->sendingServer) && $server->sendingServer->mms)
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <input type="hidden" value="mms" name="sms_type" id="sms_type">
