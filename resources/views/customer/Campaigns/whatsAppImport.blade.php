                        ...
                        <div class="card-body">
                            ...
                            <form class="form form-vertical" action="{{ route('customer.whatsapp.import') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <select class="select2 form-select" name="sending_server" id="sending_server">
                                                    @foreach($sendingServers as $server)
                                                        @if(isset($server->sendingServer) && $server->sendingServer->whatsapp)
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="language">{{ __('locale.labels.language') }}</label>
                                            <select class="form-select" id="language" name="language">
                                                <option value="0">{{ __('locale.labels.select_one') }}</option>
                                                @foreach(\App\Helpers\Helper::whatsapp_languages() as $key => $value)
