                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form class="form form-vertical" action="{{ route('customer.otp.import') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-1">
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <select class="select2 form-select" name="sending_server" id="sending_server">
                                                    @foreach($sendingServers as $server)
                                                        @if(isset($server->sendingServer) && $server->sendingServer->otp)
